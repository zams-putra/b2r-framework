export default function Pala(){
    return (
        <header className="absolute top-0 h-32 w-full bg-[#222831] z-10 flex gap-5 p-4 text-center flex-col items-center justify-center text-white font-sans font-bold">
